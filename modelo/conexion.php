...
*/ 
class conexion{
	private $servidor="sql208.infinityfree.com	
"; // NOMBRE SERVIDOR
	private $usuario="if0_37574894"; // USUARIO SERVIDOR
	private $clave="TYge7Y2QuPeJ "; // CONTRASEÑA SERVIDOR (SI LO REQUIERE)
	private $base="if0_37574894_secretdb"; // NOMBRE DE BASE DE DATOS
